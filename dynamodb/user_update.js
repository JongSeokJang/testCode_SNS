...
const userID = "skdibjcxkgkwewopqutpewkjghksdlkfwhdtjr321@gmail.com";
const userName = "장종석"
const encrypKey = misc.encrypKey
...
console.log( misc.encrypt(deviceKey, encrypKey))
let enc = misc.encrypt(deviceKey, encrypKey);
console.log( misc.decrypt(enc, encrypKey))
